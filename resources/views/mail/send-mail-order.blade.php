...
<body>
    <div class="container">
        ...
        <p class="title">
            Chúng tôi đã nhận được yêu cầu đặt hàng của bạn và đang xử lý. Bạn sẽ nhận được thông báo tiếp theo khi đơn
            hàng đã sẵn sàng được giao.
        </p>
        <div class="button">
            <a href="{{ route('orderStatus',['code'=>$feedback['order_code']]) }}" class="bold" id="link">TÌNH TRẠNG ĐƠN
                HÀNG</a>
        </div>
        <p class="note">
            ...
            <table cellpadding="2" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td valign="top"><a href="{{$feedback['to_email']}}"
                                target="_blank">{{$feedback['to_email']}}</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
                            ...
                            <td style="width:40%">
                                <div style="padding-right:10px">
                                    <a href="{{route('client.product.detail', ['id' => $valueP->slug])}}">
                                        <img src="{{asset( 'storage/' . $valueP->image)}}"
