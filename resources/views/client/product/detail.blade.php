            ...
            <div class="see_review">
                ...
                <div class="content_review">
                    ...
                    <div class="box-review">
                        ...
                        <div class="content">
                            <span class="rating">
                                @for($count=1; $count<=5; $count++) @if($count <=$rv->rating)
                                    <i class="fas fa-star rating"></i>
                                    @else
                                    <i class="far fa-star"></i>
                                    @endif
            ...
            <div class="form_review">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box">
                        <div class="col col-star">
                            ...
                            <span class="star-widget">
                                <input type="radio" value="5" name="rating" id="rate-5" @if( $check_rv->rating == 5 )
                                checked @endif>
                                <label for="rate-5" class="fas fa-star"></label>
                                <input type="radio" value="4" name="rating" id="rate-4" @if( $check_rv->rating == 4 )
                                checked @endif>
                                <label for="rate-4" class="fas fa-star"></label>
                                <input type="radio" value="3" name="rating" id="rate-3" @if( $check_rv->rating == 3 )
                                checked @endif>
                                <label for="rate-3" class="fas fa-star"></label>
                                <input type="radio" value="2" name="rating" id="rate-2" @if( $check_rv->rating == 2 )
                                checked @endif>
                                <label for="rate-2" class="fas fa-star"></label>
                                <input type="radio" value="1" name="rating" id="rate-1" @if( $check_rv->rating == 1 )
                                checked @endif>
                                <label for="rate-1" class="fas fa-star"></label>
                            </span>
                            @else
                            <span class="star-widget">
                                <input type="radio" value="5" name="rating" id="rate-5" @if( old('rating')==5 ) checked
                                    @endif>
                                <label for="rate-5" class="fas fa-star"></label>
                                <input type="radio" value="4" name="rating" id="rate-4" @if( old('rating')==4 ) checked
                                    @endif>
                                <label for="rate-4" class="fas fa-star"></label>
                                <input type="radio" value="3" name="rating" id="rate-3" @if( old('rating')==3 ) checked
                                    @endif>
                                <label for="rate-3" class="fas fa-star"></label>
                                <input type="radio" value="2" name="rating" id="rate-2" @if( old('rating')==2 ) checked
                                    @endif>
                                <label for="rate-2" class="fas fa-star"></label>
                                <input type="radio" value="1" name="rating" id="rate-1" @if( old('rating')==1 ) checked
                                    @endif>
                                <label for="rate-1" class="fas fa-star"></label>
                            </span>
                            @endif
                    ...
                    <div class="box">
                        @if(!empty($check_rv->rating) && Auth::check())
                        <div class="col">
                            <textarea name="comment" placeholder="Review" cols="30"
                                rows="10">{{ $check_rv->comment }}</textarea>
                        </div>
                        @else
                        <div class="col">
                            <textarea name="comment" placeholder="Review" cols="30"
