            ...
            <div class="double">
                <div class="form-item">
                    ...
                    <select name="cate_id" id="">
                        ...
                        <option @if(isset($searchData['cate_id']) && $searchData['cate_id']==$cate->id) selected @endif
                ...
                <div class="form-item">
                    ...
                    <select name="order_by" id="">
                        ...
                        <option @if(isset($searchData['order_by']) && $searchData['order_by']==1) selected @endif
                            value="1">Giá tăng dần</option>
                        <option @if(isset($searchData['order_by']) && $searchData['order_by']==2) selected @endif
                            value="2">Giá giảm dần</option>
                        <option @if(isset($searchData['order_by']) && $searchData['order_by']==3) selected @endif
                            value="3">Sản phẩm mới nhất</option>
                    </select>
                </div>
            </div>
