                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="general_setting_id" class="form-control" id="General-setting">
                                    ...
                                    <option value="{{$g->id}}">{{$g->phone}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="type" id="type" class="form-control" placeholder="Kiểu">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="url" id="url" class="form-control" placeholder="Đường dẫn">
